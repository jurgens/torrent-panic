...
CREATE TABLE IF NOT EXISTS "releases" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "movie_id" integer, "title" varchar, "status" varchar, "page_url" varchar, "magnet" varchar, CONSTRAINT "fk_rails_74cf2831f2"
FOREIGN KEY ("movie_id")
  REFERENCES "movies" ("id")
);
