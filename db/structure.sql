...
CREATE TABLE IF NOT EXISTS "users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "first_name" varchar, "last_name" varchar, "last_update_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "telegram_id" integer, "status" varchar, "language" varchar, "locale" varchar, "error" integer DEFAULT 0);
...
CREATE TABLE IF NOT EXISTS "releases" ("id" integer NOT NULL PRIMARY KEY, "movie_id" integer DEFAULT NULL, "title" varchar DEFAULT NULL, "status" varchar DEFAULT NULL, "link" varchar DEFAULT NULL, "magnet" varchar DEFAULT NULL, "seeds" integer, "size" integer, "downloads" integer);
