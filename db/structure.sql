...
CREATE TABLE IF NOT EXISTS "users" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "first_name" varchar, "last_name" varchar, "last_update_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "telegram_id" integer, "status" varchar, "language" varchar);
